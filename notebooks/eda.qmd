...
# Combined = all reading-level heuristics + session warmup/tail + calibration windows
combined = instability_mask(glucose_arr)
combined = combined | _pad_mask(m_warmup_tail, n) | _pad_mask(m_calibration, n)
